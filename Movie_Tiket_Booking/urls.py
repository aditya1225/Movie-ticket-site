...
urlpatterns = [
    ...
    path('view_cinema', View_Cinema,name="view_cinema"),
    path('edit_cinema<int:pid>', Edit_Cinema,name="edit_cinema"),
    path('all_cinema', All_Cinema,name="all_cinema"),
    path('delete_cinema<int:pid>', delete_cinema,name="delete_cinema"),
    ...
    path('delete_bookingadm<int:pid>', delete_bookingadm,name="delete_bookingadm"),
